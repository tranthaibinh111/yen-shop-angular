...
export const products: Product[] = [
  {
    ...
    price: 3200000,
    compareAtPrice: null,
    images: ['assets/images/products/1/yen-tinh-100.webp'],
    badges: ['hot'],
    rating: 5,
    reviews: 0,
  ...
  },
  {
    ...
    price: 1800000,
    compareAtPrice: null,
    images: ['assets/images/products/2/yen-tinh-50.webp', 'assets/images/products/2/yen-tinh-50-1.webp'],
    badges: [],
    rating: 3,
    reviews: 0,
    availability: 'Còn hàng',
  ...
  },
  {
    ...
    price: 2600000,
    compareAtPrice: null,
    images: ['assets/images/products/3/yen-tho-100.webp'],
    badges: [],
    rating: 4,
    reviews: 0,
    availability: 'Còn hàng',
  ...
  },
  {
    ...
    price: 1500000,
    compareAtPrice: null,
    images: ['assets/images/products/4/yen-tho-50.webp'],
    badges: ['sale'],
    rating: 3,
    reviews: 0,
    availability: 'Còn hàng',
